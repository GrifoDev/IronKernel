 ...
 *
 * exynos fimc-is2_dream video functions
 *
...
static int fimc_is_ssxvc0_video_open(struct file *file)
{
	...
	ret = open_vctx(file, video, &vctx, device->instance, FRAMEMGR_ID_SSXVC0);
	if (ret) {
